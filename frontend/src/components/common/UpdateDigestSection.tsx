...
export default function UpdateDigestSection({
  ...
  return (
    <SectionReveal className="mt-10 rounded-3xl border border-gray-200/70 bg-white p-5 dark:border-gray-800 dark:bg-gray-900/60 sm:p-6">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-3">
        {items.map((item) => (
          <Link
            ...
            className="group rounded-2xl border border-gray-200 bg-gray-50/60 p-4 transition hover:-translate-y-0.5 hover:shadow-sm dark:border-gray-700 dark:bg-gray-950/50"
          >
            ...
            <p className="mt-2 text-sm font-medium text-gray-900 transition-colors group-hover:text-gray-700 dark:text-gray-100 dark:group-hover:text-gray-200">{item.title}</p>
